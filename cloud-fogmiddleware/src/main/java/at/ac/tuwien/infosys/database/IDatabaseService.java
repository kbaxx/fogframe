...
public interface IDatabaseService {
    ...
    int getPort();
    Fogdevice getParent();
    Set<Fogcontrolnode> getChildren();
    ...
    void setChildren(Set<Fogcontrolnode> children);
    void addChild(Fogcontrolnode child);
    void removeChild(Fogcontrolnode child);
    void removeChildren();
    void setLocation(Location loc);
    void addParent(Fogcontrolnode parent);
    void removeParent(Fogcontrolnode parent);
    void removeParents();
